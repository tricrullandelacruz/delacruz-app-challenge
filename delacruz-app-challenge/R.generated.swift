...
struct R: Rswift.Validatable {
  ...
  struct nib {
    /// Nib `MoviesListCollectionViewCell`.
    static let moviesListCollectionViewCell = _R.nib._MoviesListCollectionViewCell()

    #if os(iOS) || os(tvOS)
    /// `UINib(name: "MoviesListCollectionViewCell", in: bundle)`
    @available(*, deprecated, message: "Use UINib(resource: R.nib.moviesListCollectionViewCell) instead")
    static func moviesListCollectionViewCell(_: Void = ()) -> UIKit.UINib {
      return UIKit.UINib(resource: R.nib.moviesListCollectionViewCell)
    }
    #endif

    static func moviesListCollectionViewCell(owner ownerOrNil: AnyObject?, options optionsOrNil: [UINib.OptionsKey : Any]? = nil) -> MoviesListCollectionViewCell? {
      return R.nib.moviesListCollectionViewCell.instantiate(withOwner: ownerOrNil, options: optionsOrNil)[0] as? MoviesListCollectionViewCell
    }
  ...
  struct reuseIdentifier {
    /// Reuse identifier `MoviesListCollectionViewCell`.
    static let moviesListCollectionViewCell: Rswift.ReuseIdentifier<MoviesListCollectionViewCell> = Rswift.ReuseIdentifier(identifier: "MoviesListCollectionViewCell")
...
struct _R: Rswift.Validatable {
  ...
  #if os(iOS) || os(tvOS)
  struct nib {
    struct _MoviesListCollectionViewCell: Rswift.NibResourceType, Rswift.ReuseIdentifierType {
      typealias ReusableType = MoviesListCollectionViewCell

      let bundle = R.hostingBundle
      let identifier = "MoviesListCollectionViewCell"
      let name = "MoviesListCollectionViewCell"

      func firstView(owner ownerOrNil: AnyObject?, options optionsOrNil: [UINib.OptionsKey : Any]? = nil) -> MoviesListCollectionViewCell? {
        return instantiate(withOwner: ownerOrNil, options: optionsOrNil)[0] as? MoviesListCollectionViewCell
      }
